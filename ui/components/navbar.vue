...
<template>
  <aside class="relative w-1/5 px-2">
    <nav class="pt-2">
      <NuxtLink to="/" class="group">
        <svg
          viewBox="0 0 15 15"
          xmlns="http://www.w3.org/2000/svg"
          class="w-14 h-14 p-3 rounded-full group-hover:bg-gray-900"
        >
          <path
      ...
      <ul class="space-y-2">
        <li>
          <NuxtLink to="/" class="flex items-center p-3 space-x-4 rounded-3xl hover:bg-gray-900">
        ...
        <li>
          <NuxtLink to="/" class="flex items-center p-3 space-x-4 rounded-3xl hover:bg-gray-900">
            ...
            <div class="text-xl">Bookmarks</div>
          </NuxtLink>
        </li>
        <li>
          <NuxtLink to="/" class="flex items-center p-3 space-x-4 rounded-3xl hover:bg-gray-900">
        ...
        <li>
          <NuxtLink to="/" class="flex items-center p-3 space-x-4 rounded-3xl hover:bg-gray-900">
            <EllipsisHorizontalCircleIcon class="w-7 h-7" />
            <div class="text-xl">More</div>
          </NuxtLink>
        </li>
      </ul>
    </nav>
    <button type="button" class="w-[90%] mt-4 py-3 rounded-3xl bg-blue-500 text-lg">Tweet</button>
    <button
      type="button"
